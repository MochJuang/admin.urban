...
var isEdit = false
    ...
    table.DataTable({
        ...
        'columns': [
            ...
            {
                render: function (data, type, full, meta) {
                    return full.khusus == null || full.khusus == 0 ? 'No' : 'Ya';
                }
            },
            {
                render: function (data, type, full, meta) {
                   ...
                   if (full.jenis == 1) {
                       jenis = 'persen'
                   }else if(full.jenis == 2){
                    jenis = 'nomonal'
                   }else if(full.jenis == 3){
                    jenis = 'tofor'
                   }else if(full.jenis == 4){
                    jenis = 'Gratis Ongkir'
                }

                    return jenis == null ? '-' : jenis;
                }
            },
            {
                render: function (data, type, full, meta) {
                ...
                render: function (data, type, full, meta) {
                    return full.promo == null ? '-' : full.promo + ' %';
                }
            }, {
                render: function (data, type, full, meta) {
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-promo">
                    ...
                    <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="name">Promo Khusus<span class="required" style="color:#ff3333;">*</span>
                            </label>
                            <div class="col-sm-10">
                            <div class="form-check">
                        <input class="form-check-input" name="khusus" type="checkbox" value="1" id="khusus">

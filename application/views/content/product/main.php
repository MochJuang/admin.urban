                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="form-group row" style="margin-top: 20px;">
                                        ...
                                        <div class="col-sm-2">
                                            <select id="select-subKategori" class="js-example-basic-single col-sm-12" name="kategori_id" placeholder="id_usr_role" type="text" required="required">
                                                <option value="">Pilih SubKategori</option>
                                            </select>
                                        </div>
                                        <div class="col-sm-2">
                                            <select id="select-subKategoriLv2" class="js-example-basic-single col-sm-12" name="kategori_id" placeholder="id_usr_role" type="text" required="required">
                                                <option value="">Pilih SubKategori Level2</option>
                                ...
                                <div class="card-block">
                                    <div class="dt-responsive table-responsive">
                                        ...
                                        <button data-toggle="modal" data-target="#modal-container-promo" id="modal-btn-promo" style="float:right;height: 36px;margin-right:10px" title="Add/Edit Color" class="btn btn-success">
                                            Update Promo
                                        </button>
                                        ...
                                        <table id="table-product" class="table table-striped table-bordered nowrap">
                                            <thead>
                                                <tr>
                                                    <th>No</th>
                                                    <th>Status</th>
            ...
            <div class="modal-body">
                <form id="form-product">
                    <div>
                        ...
                        <input type="text" name="kode_product" id="kode_product" hidden>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select id="select-kategori" class="js-example-basic-single col-sm-12" name="" placeholder="id_usr_role" type="text" required="required" disabled>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label" for="name">Sub Kategori Level 2<span class="required" style="color:#ff3333;">*</span>
                        </label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label" for="name">Kode Product<span class="required" style="color:#ff3333;">*</span>
                        </label>
                        <div class="col-sm-10">
                            <input id="kodes" class="form-control" name="kodes" placeholder="Nama Artikel" type="text" disabled>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input id="harga" class="form-control" name="harga" placeholder="Harga Produk" type="text" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label" for="name">Deskripsi
                        </label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label" for="name">Promo
                        </label>
                        <div class="col-sm-10">
...
<script>
    var id_kategoris = "<?= $this->uri->segment('3') ?>";
